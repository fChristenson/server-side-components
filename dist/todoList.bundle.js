...
const styles = __webpack_require__(0);
const Store = __webpack_require__(7);
const reducer = __webpack_require__(9);
const { UPDATE_TODOS, INIT_TODO_LIST } = __webpack_require__(8);
const { removeChildren, buildTodoList } = __webpack_require__(1);
...
const UPDATE_TODOS = "todoList.updateTodos";
module.exports.UPDATE_TODOS = UPDATE_TODOS;

const INIT_TODO_LIST = "todoList.initTodoList";
module.exports.INIT_TODO_LIST = INIT_TODO_LIST;
